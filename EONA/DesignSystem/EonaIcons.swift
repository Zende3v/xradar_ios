...
enum EonaSymbol: String, CaseIterable {
...
extension PlaceCategory {
    ...
    var color: Color {
        switch self {
        case .fuel: EonaColor.radarMobile
        case .charging: EonaColor.success
        case .parking: EonaColor.info
        case .tobacco: EonaColor.danger
        case .garage: EonaColor.textSecondary
        case .hotel: EonaColor.controlZone
        case .atm: EonaColor.radarFixed
        }
    }
}
